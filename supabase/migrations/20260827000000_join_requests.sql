...
DROP TRIGGER IF EXISTS set_updated_at ON join_requests;
...
DROP POLICY IF EXISTS join_requests_select_own ON join_requests;
...
DROP POLICY IF EXISTS join_requests_update_admin ON join_requests;
