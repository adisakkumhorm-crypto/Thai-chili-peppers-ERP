-- Change idempotency_key to TEXT to support wider range of keys
ALTER TABLE public.inventory_transactions DROP COLUMN IF EXISTS idempotency_key CASCADE;
ALTER TABLE public.inventory_transactions ADD COLUMN idempotency_key TEXT;
...
BEGIN
    ...
    -- 5. Update Global Product Stock (Compatibility with legacy)
